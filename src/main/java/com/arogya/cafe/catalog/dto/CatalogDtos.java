...
public final class CatalogDtos {
    ...
    public record MenuItemResponse(
        ...
        public static MenuItemResponse from(MenuItem m) {
            return new MenuItemResponse(m.getId(), m.getName(), m.getSizeVariant(), m.getPrice(),
    ...
    public record ItemIngredientResponse(
            Long id, Long menuItemId, Long ingredientId, String ingredientName,
            BigDecimal quantity, String unit, String sizeVariant) {
        public static ItemIngredientResponse from(ItemIngredient ii) {
            return new ItemIngredientResponse(ii.getId(), ii.getMenuItem().getId(), ii.getIngredient().getId(),
                    ii.getIngredient().getName(), ii.getQuantity(), ii.getUnit(), ii.getSizeVariant());
        }
    }
}
